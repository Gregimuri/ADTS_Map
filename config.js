...
const CONFIG = {
    ...
    // НАСТРОЙКИ ГЕОКОДИРОВАНИЯ (УЛУЧШЕННЫЕ)
    GEOCODING: {
        enabled: true,
        // Алгоритм поиска: Нормализация → Яндекс → OpenStreetMap
        // Яндекс без API (публичный поиск)
        // Задержки между запросами (мс)
        delays: {
            yandex: 500,     // 500ms между запросами к Яндексу
            nominatim: 1000  // 1 секунда между запросами к OSM (требование API)
        },
        // Максимальное количество одновременных запросов
        maxConcurrent: 1,    // Уменьшено для избежания блокировок
        ...
        osmUserAgent: 'TTMapApp/1.0 (tt-map@example.com)'
    }
};
