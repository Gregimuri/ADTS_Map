...
function getRandomCoordinate(address, region = '') {
    const regionCoords = {
        ...
        'Москва обл.': { lat: 55.7558, lng: 37.6173, radius: 0.2 },
        'Московская': { lat: 55.7558, lng: 37.6173, radius: 0.2 },
        'Московская обл.': { lat: 55.7558, lng: 37.6173, radius: 0.2 },
        ...
        'Ленинградская обл.': { lat: 59.9343, lng: 30.3351, radius: 0.2 },
        ...
        'Красноярский': { lat: 56.0184, lng: 92.8672, radius: 0.3 },
        'Красноярский край': { lat: 56.0184, lng: 92.8672, radius: 0.3 },
        
        'Ставропольский': { lat: 45.0433, lng: 41.9691, radius: 0.2 },
        'Ставропольский край': { lat: 45.0433, lng: 41.9691, radius: 0.2 },
        
        'Пермский': { lat: 58.0105, lng: 56.2502, radius: 0.2 },
        'Пермский край': { lat: 58.0105, lng: 56.2502, radius: 0.2 },
        
        'Забайкальский': { lat: 52.0333, lng: 113.5500, radius: 0.3 },
        'Забайкальский край': { lat: 52.0333, lng: 113.5500, radius: 0.3 },
        
        'Камчатский': { lat: 53.0370, lng: 158.6559, radius: 0.3 },
        'Камчатский край': { lat: 53.0370, lng: 158.6559, radius: 0.3 },
        
        'Приморский': { lat: 43.1155, lng: 131.8855, radius: 0.2 },
        'Приморский край': { lat: 43.1155, lng: 131.8855, radius: 0.2 },
        
        'Хабаровский': { lat: 48.4802, lng: 135.0719, radius: 0.2 },
        'Хабаровский край': { lat: 48.4802, lng: 135.0719, radius: 0.2 },
        
        // Области
        'Амурская': { lat: 50.2907, lng: 127.5272, radius: 0.3 },
        'Архангельская': { lat: 64.5393, lng: 40.5187, radius: 0.5 },
        'Архангельская обл.': { lat: 64.5393, lng: 40.5187, radius: 0.5 },
        
        'Астраханская': { lat: 46.3479, lng: 48.0336, radius: 0.3 },
        'Астраханская обл.': { lat: 46.3479, lng: 48.0336, radius: 0.3 },
        
        'Белгородская': { lat: 50.5952, lng: 36.5872, radius: 0.2 },
        'Белгородская обл.': { lat: 50.5952, lng: 36.5872, radius: 0.2 },
        
        'Брянская': { lat: 53.2434, lng: 34.3642, radius: 0.2 },
        'Брянская обл.': { lat: 53.2434, lng: 34.3642, radius: 0.2 },
        
        'Владимирская': { lat: 56.1290, lng: 40.4070, radius: 0.2 },
        'Владимирская обл.': { lat: 56.1290, lng: 40.4070, radius: 0.2 },
        
        'Волгоградская': { lat: 48.7080, lng: 44.5133, radius: 0.2 },
        'Волгоградская обл.': { lat: 48.7080, lng: 44.5133, radius: 0.2 },
        
        'Вологодская': { lat: 59.2181, lng: 39.8886, radius: 0.2 },
        'Вологодская обл.': { lat: 59.2181, lng: 39.8886, radius: 0.2 },
        
        'Воронежская': { lat: 51.6755, lng: 39.2089, radius: 0.2 },
        'Воронежская обл.': { lat: 51.6755, lng: 39.2089, radius: 0.2 },
        
        'Ивановская': { lat: 57.0004, lng: 40.9739, radius: 0.2 },
        'Ивановская обл.': { lat: 57.0004, lng: 40.9739, radius: 0.2 },
        
        'Иркутская': { lat: 52.2896, lng: 104.2806, radius: 0.3 },
        'Иркутская обл.': { lat: 52.2896, lng: 104.2806, radius: 0.3 },
        
        'Калининградская': { lat: 54.7104, lng: 20.4522, radius: 0.1 },
        'Калининградская обл.': { lat: 54.7104, lng: 20.4522, radius: 0.1 },
        
        'Калужская': { lat: 54.5138, lng: 36.2612, radius: 0.2 },
        'Калужская обл.': { lat: 54.5138, lng: 36.2612, radius: 0.2 },
        
        'Кемеровская': { lat: 55.3547, lng: 86.0873, radius: 0.2 },
        'Кемеровская обл.': { lat: 55.3547, lng: 86.0873, radius: 0.2 },
        
        'Кировская': { lat: 58.6035, lng: 49.6680, radius: 0.2 },
        'Кировская обл.': { lat: 58.6035, lng: 49.6680, radius: 0.2 },
        
        'Костромская': { lat: 58.5500, lng: 43.6833, radius: 0.2 },
        'Костромская обл.': { lat: 58.5500, lng: 43.6833, radius: 0.2 },
        
        'Курганская': { lat: 55.4410, lng: 65.3411, radius: 0.2 },
        'Курганская обл.': { lat: 55.4410, lng: 65.3411, radius: 0.2 },
        
        'Курская': { lat: 51.7370, lng: 36.1874, radius: 0.2 },
        'Курская обл.': { lat: 51.7370, lng: 36.1874, radius: 0.2 },
        
        'Липецкая': { lat: 52.6088, lng: 39.5992, radius: 0.2 },
        'Липецкая обл.': { lat: 52.6088, lng: 39.5992, radius: 0.2 },
        
        'Мурманская': { lat: 68.9585, lng: 33.0827, radius: 0.3 },
        'Мурманская обл.': { lat: 68.9585, lng: 33.0827, radius: 0.3 },
        
        'Нижегородская': { lat: 56.3269, lng: 44.0065, radius: 0.2 },
        'Нижегородская обл.': { lat: 56.3269, lng: 44.0065, radius: 0.2 },
        
        'Новгородская': { lat: 58.5228, lng: 31.2698, radius: 0.2 },
        'Новгородская обл.': { lat: 58.5228, lng: 31.2698, radius: 0.2 },
        
        'Новосибирская': { lat: 55.0084, lng: 82.9357, radius: 0.2 },
        'Новосибирская обл.': { lat: 55.0084, lng: 82.9357, radius: 0.2 },
        'Новосибирск': { lat: 55.0084, lng: 82.9357, radius: 0.05 },
        
        'Омская': { lat: 54.9914, lng: 73.3715, radius: 0.2 },
        'Омская обл.': { lat: 54.9914, lng: 73.3715, radius: 0.2 },
        
        'Оренбургская': { lat: 51.7682, lng: 55.0974, radius: 0.2 },
        'Оренбургская обл.': { lat: 51.7682, lng: 55.0974, radius: 0.2 },
        
        'Орловская': { lat: 52.9671, lng: 36.0696, radius: 0.2 },
        'Орловская обл.': { lat: 52.9671, lng: 36.0696, radius: 0.2 },
        
        'Пензенская': { lat: 53.2007, lng: 45.0046, radius: 0.2 },
        'Пензенская обл.': { lat: 53.2007, lng: 45.0046, radius: 0.2 },
        
        'Псковская': { lat: 57.8194, lng: 28.3318, radius: 0.2 },
        'Псковская обл.': { lat: 57.8194, lng: 28.3318, radius: 0.2 },
        
        'Ростовская': { lat: 47.2224, lng: 39.7189, radius: 0.2 },
        'Ростовская обл.': { lat: 47.2224, lng: 39.7189, radius: 0.2 },
        
        'Рязанская': { lat: 54.6269, lng: 39.6916, radius: 0.2 },
        'Рязанская обл.': { lat: 54.6269, lng: 39.6916, radius: 0.2 },
        
        'Самарская': { lat: 53.1959, lng: 50.1002, radius: 0.2 },
        'Самарская обл.': { lat: 53.1959, lng: 50.1002, radius: 0.2 },
        
        'Саратовская': { lat: 51.5924, lng: 45.9608, radius: 0.2 },
        'Саратовская обл.': { lat: 51.5924, lng: 45.9608, radius: 0.2 },
        
        'Сахалинская': { lat: 46.9591, lng: 142.7380, radius: 0.3 },
        'Сахалинская обл.': { lat: 46.9591, lng: 142.7380, radius: 0.3 },
        
        'Свердловская': { lat: 56.8389, lng: 60.6057, radius: 0.2 },
        'Свердловская обл.': { lat: 56.8389, lng: 60.6057, radius: 0.2 },
        
        'Смоленская': { lat: 54.7826, lng: 32.0453, radius: 0.2 },
        'Смоленская обл.': { lat: 54.7826, lng: 32.0453, radius: 0.2 },
        
        'Тамбовская': { lat: 52.7212, lng: 41.4523, radius: 0.2 },
        'Тамбовская обл.': { lat: 52.7212, lng: 41.4523, radius: 0.2 },
        'Тамбовская область': { lat: 52.7212, lng: 41.4523, radius: 0.2 },
        
        'Тверская': { lat: 56.8587, lng: 35.9176, radius: 0.2 },
        'Тверская обл.': { lat: 56.8587, lng: 35.9176, radius: 0.2 },
        
        'Томская': { lat: 56.4846, lng: 84.9476, radius: 0.2 },
        'Томская обл.': { lat: 56.4846, lng: 84.9476, radius: 0.2 },
        
        'Тульская': { lat: 54.1920, lng: 37.6173, radius: 0.2 },
        'Тульская обл.': { lat: 54.1920, lng: 37.6173, radius: 0.2 },
        
        'Тюменская': { lat: 57.1530, lng: 65.5343, radius: 0.2 },
        'Тюменская обл.': { lat: 57.1530, lng: 65.5343, radius: 0.2 },
        
        'Ульяновская': { lat: 54.3142, lng: 48.4031, radius: 0.2 },
        'Ульяновская обл.': { lat: 54.3142, lng: 48.4031, radius: 0.2 },
        
        'Челябинская': { lat: 55.1644, lng: 61.4368, radius: 0.2 },
        'Челябинская обл.': { lat: 55.1644, lng: 61.4368, radius: 0.2 },
        
        'Ярославская': { lat: 57.6261, lng: 39.8845, radius: 0.2 },
        'Ярославская обл.': { lat: 57.6261, lng: 39.8845, radius: 0.2 },
        
        // Республики
        'Татарстан': { lat: 55.7961, lng: 49.1064, radius: 0.2 },
        'Респ. Татарстан': { lat: 55.7961, lng: 49.1064, radius: 0.2 },
        'Республика Татарстан': { lat: 55.7961, lng: 49.1064, radius: 0.2 },
        
        'Башкортостан': { lat: 54.7351, lng: 55.9587, radius: 0.2 },
        'Респ. Башкортостан': { lat: 54.7351, lng: 55.9587, radius: 0.2 },
        'Республика Башкортостан': { lat: 54.7351, lng: 55.9587, radius: 0.2 },
        
        'Удмуртская': { lat: 57.0670, lng: 53.0270, radius: 0.2 },
        'Удмуртская респ.': { lat: 57.0670, lng: 53.0270, radius: 0.2 },
        'Удмуртия': { lat: 57.0670, lng: 53.0270, radius: 0.2 },
        
        'Чувашская': { lat: 56.1439, lng: 47.2489, radius: 0.2 },
        'Чувашская респ.': { lat: 56.1439, lng: 47.2489, radius: 0.2 },
        'Чувашия': { lat: 56.1439, lng: 47.2489, radius: 0.2 },
        
        'Марий Эл': { lat: 56.6380, lng: 47.8951, radius: 0.2 },
        'Респ. Марий Эл': { lat: 56.6380, lng: 47.8951, radius: 0.2 },
        
        'Мордовия': { lat: 54.1874, lng: 45.1839, radius: 0.2 },
        'Респ. Мордовия': { lat: 54.1874, lng: 45.1839, radius: 0.2 },
        
        'Адыгея': { lat: 44.6098, lng: 40.1006, radius: 0.2 },
        'Респ. Адыгея': { lat: 44.6098, lng: 40.1006, radius: 0.2 },
        
        'Дагестан': { lat: 42.9849, lng: 47.5047, radius: 0.2 },
        'Респ. Дагестан': { lat: 42.9849, lng: 47.5047, radius: 0.2 },
        
        'Кабардино-Балкар': { lat: 43.4847, lng: 43.6071, radius: 0.2 },
        'Кабардино-Балкарская': { lat: 43.4847, lng: 43.6071, radius: 0.2 },
        
        'Калмыкия': { lat: 46.3079, lng: 44.2700, radius: 0.2 },
        'Калмыкия респ.': { lat: 46.3079, lng: 44.2700, radius: 0.2 },
        'Республика Калмыкия': { lat: 46.3079, lng: 44.2700, radius: 0.2 },
        
        'Карачаево-Черкесская': { lat: 43.9159, lng: 41.7740, radius: 0.2 },
        'Карачаево-Черкесия': { lat: 43.9159, lng: 41.7740, radius: 0.2 },
        
        'Карелия': { lat: 61.7850, lng: 34.3468, radius: 0.3 },
        'Республика Карелия': { lat: 61.7850, lng: 34.3468, radius: 0.3 },
        
        'Коми': { lat: 61.6688, lng: 50.8354, radius: 0.3 },
        'Коми респ.': { lat: 61.6688, lng: 50.8354, radius: 0.3 },
        'Республика Коми': { lat: 61.6688, lng: 50.8354, radius: 0.3 },
        
        'Северная Осетия': { lat: 43.0241, lng: 44.6814, radius: 0.2 },
        'Северная Осетия - Алания': { lat: 43.0241, lng: 44.6814, radius: 0.2 },
        
        'Хакасия': { lat: 53.7224, lng: 91.4435, radius: 0.2 },
        'Хакассия': { lat: 53.7224, lng: 91.4435, radius: 0.2 },
        
        // Автономные округа
        'ХМАО': { lat: 61.0032, lng: 69.0189, radius: 0.5 },
        'Ханты-Мансийский': { lat: 61.0032, lng: 69.0189, radius: 0.5 },
        'Ханты-Мансийский АО': { lat: 61.0032, lng: 69.0189, radius: 0.5 },
        
        'ЯНАО': { lat: 66.5299, lng: 66.6136, radius: 0.5 },
        'Ямало-Ненецкий': { lat: 66.5299, lng: 66.6136, radius: 0.5 },
        'Ямало-Ненецкий АО': { lat: 66.5299, lng: 66.6136, radius: 0.5 },
        
        // Города федерального значения
        'Сочи': { lat: 43.5855, lng: 39.7231, radius: 0.05 },
    ...
    const searchText = (region || address || '').toLowerCase().trim();
    
    console.log(`🔍 Поиск координат для региона: "${region}" (${searchText})`);
    
    // Удаляем лишние символы и нормализуем
    let normalizedRegion = searchText
        .replace(/область/i, 'обл.')
        .replace(/обл$/i, 'обл.')
        .replace(/край$/i, 'край')
        .replace(/респ$/i, 'респ.')
        .replace(/республика/i, 'респ.')
        .trim();
    ...
    for (const [key, coords] of Object.entries(regionCoords)) {
        ...
        if (searchText === keyLower || normalizedRegion === keyLower) {
            baseLat = coords.lat;
            baseLng = coords.lng;
        ...
        if (searchText.includes(keyLower) || keyLower.includes(searchText)) {
            baseLat = coords.lat;
            baseLng = coords.lng;
            radius = coords.radius;
    ...
    // Если не нашли по стандартным ключам, ищем по основным словам
    if (baseLat === 55.7558 && baseLng === 37.6173) {
        const regionWords = searchText.split(' ');
        
        for (const [key, coords] of Object.entries(regionCoords)) {
            const keyWords = key.toLowerCase().split(' ');
            
            // Проверяем, есть ли общие слова
            const commonWords = regionWords.filter(word => 
            ...
            if (commonWords.length > 0) {
                ...
                baseLng = coords.lng;
                radius = coords.radius;
                console.log(`📍 Найдено по общим словам: ${key} (${commonWords.join(', ')})`);
                break;
            }
        }
    }
    ...
    console.log(`📍 Координаты: ${randomLat.toFixed(6)}, ${randomLng.toFixed(6)}`);
